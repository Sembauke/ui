...
type DropdownMenuProps = Props<MenuTag, MenuRenderPropArg, never, {
    __demoMode?: boolean;
}>;
...
type DropDownButtonProps = Props<"button", ButtonRenderPropArg, ButtonPropsWeControl, {
    disabled?: boolean;
}>;
export declare const MenuItems: React.ForwardRefExoticComponent<{
    ...
    as?: "button" | undefined;
    children?: React.ReactNode | ((bag: ButtonRenderPropArg) => React.ReactElement<any, string | React.JSXElementConstructor<any>>);
    refName?: string | undefined;
} & {
    className?: string | ((bag: ButtonRenderPropArg) => string) | undefined;
} & {
    disabled?: boolean | undefined;
} & React.RefAttributes<HTMLDivElement>>;
export declare const Dropdown: {
    ({ children, dropup, ...props }: DropdownProps): JSX.Element;
